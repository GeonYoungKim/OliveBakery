    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12 text-center">
                    <div id="carousel-example-generic" class="carousel slide">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <img class="img-responsive img-full" src="<%=cp%>/resources/bootstrap/img/bread-1.png" alt="">
                            </div>
                            <div class="item">
                                <img class="img-responsive img-full" src="<%=cp%>/resources/bootstrap/img/bread-2.jpg" alt="">
                            </div>
                            <div class="item">
                                <img class="img-responsive img-full" src="<%=cp%>/resources/bootstrap/img/bread-3.jpg" alt="">
                            </div>
                        </div>
                    ...
                    <h1 class="brand-name">Olive Bakery</h1>
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    <hr>
                    <h2 class="intro-text text-center">찾아 오는 길                         
                    </h2>
                    <hr>
                    <img class="img-responsive img-border img-left" src="<%=cp%>/resources/bootstrap/img/breadroad.png" alt="">
                    <hr class="visible-xs">
