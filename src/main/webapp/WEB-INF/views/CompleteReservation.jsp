...
<%
	...
	Long nowTime=(Long)request.getAttribute("time");
            ...
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <hr>
                		...
                		<br><br><br>
                        <strong>주문 내역</strong><br>
                        <strong>ID = <%=id %></strong><br>
                        <strong>address = <%=address %></strong><br>
                        <strong>requirement = <%=requirement %></strong><br>
                        <table class="type11">
						    <thead>
						    <tr>
						    ...
						    <%for(int i=0;i<reservationlist.size();i++){ 
						    	if(nowTime.equals(reservationlist.get(i).getTime())){
						    %>
						    <tr>
						        <td><%=reservationlist.get(i).getBreadname()%></th>
						        <td><%=reservationlist.get(i).getBreadquantity()%></th>
						    </tr>
						    <%} }%>
						    </tbody>
						</table>
